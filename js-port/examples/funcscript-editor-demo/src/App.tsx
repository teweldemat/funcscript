      ...
      <section className="editor-panel">
        <header className="panel-header">
          <div>
            ...
            <h1>FuncScriptEditor minimal repro</h1>
            <p className="subtitle">
              Type directly in the editor to see how color segments, parse nodes,
              and runtime errors respond. Use this mini app to isolate syntax
              highlighting bugs away from the full CIS portal.
            </p>
          </div>
        ...
        <div className="helper-text">
          The editor relies on <code>@tewelde/funcscript</code> for parsing. If
          syntax coloring fails, check the "Segments" and "Parser output"
          panels for mismatches.
        </div>
      </section>
          ...
          <div className="segments-header">
            ...
            {overflowCount > 0 && (
              <span className="muted">
                Showing first {visibleSegments.length} entries
              </span>
            )}
          </div>
