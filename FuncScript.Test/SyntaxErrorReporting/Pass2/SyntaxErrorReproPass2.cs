...
namespace FuncScript.Test
{
    public class SyntaxErrorReproPass2
    {
        ...
        public static IEnumerable<TestCaseData> SyntaxErrorCases()
        {
            ...
            yield return Case(52, "OuterMissingSeparator", "{outer:{inner:1 inner2:2}}");
            yield return Case(53, "NestedMissingValue", "{outer:{inner:{deep:}}}");
            yield return Case(54, "NestedMissingSeparator", "{outer:{inner:{deep:1 deeper:2}}}");
            ...
            yield return Case(58, "NestedObjectInListMissingSeparator", "{outer:{inner:{list:[{a:1 b:2}]}}}");
            yield return Case(59, "DeepNestedValueMissing", "{outer:{inner:{list:[{a:{b:}}]}}}");
            yield return Case(60, "DeepNestedSeparatorMissing", "{outer:{inner:{list:[{a:{b:1 c:2}}]}}}");
            ...
            yield return Case(65, "LambdaBodyMissingSeparator", "{outer:{inner:(x)=>{node:{leaf:1 twig:2}}}}");
            yield return Case(66, "LambdaListMissingComma", "{outer:{inner:(x)=>{node:[1 2]}}}");
            yield return Case(67, "LambdaListObjectMissingSeparator", "{outer:{inner:(x)=>{node:[{leaf:1 twig:2}]}}}");
            ...
            yield return Case(70, "LambdaReturningLambdaMissingSeparator", "{outer:{inner:(x)=>{return (y)=>{leaf:1 twig:2};}}}");
            yield return Case(71, "CombinatorReturnMissingSeparator", "{outer:{combinator:(x,y)=>{return {a:1 b:2};}}}");
            yield return Case(72, "CombinatorReturnNestedMissingValue", "{outer:{combinator:(x)=>{return {a:{b:}};}}}");
            yield return Case(73, "CombinatorReturnNestedMissingSeparator", "{outer:{combinator:(x)=>{return {a:{b:1 c:2}};}}}");
            yield return Case(74, "CombinatorReturnListObjectMissingSeparator", "{outer:{combinator:(x)=>{return [{a:1 b:2}];}}}");
            yield return Case(75, "CombinatorReturnLambdaReturnMissingValue", "{outer:{combinator:(x)=>{return [(y)=>{return;}];}}}");
            yield return Case(76, "CombinatorReturnLambdaBodyMissingSeparator", "{outer:{combinator:(x)=>{return [(y)=>{a:1 b:2}];}}}");
            ...
            yield return Case(81, "LambdaSwitchCaseValueMissingSeparator", "{outer:{logic:(x)=>{return switch { case 1: {a:1 b:2} };}}}");
            yield return Case(82, "ArrayOfLambdaReturnMissingSeparator", "{outer:{array:[{lambda:(x)=>{return {a:1 b:2};}}]}}");
            ...
            yield return Case(85, "ArrayLambdaBodyMissingSeparator", "{outer:{array:[{lambda:(x)=>{node:{leaf:1 twig:2}}}]}}");
            ...
            yield return Case(88, "ArrayLambdaReturningLambdaMissingSeparator", "{outer:{array:[{lambda:(x)=>{return (y)=>{leaf:1 twig:2};}}]}}");
            ...
            yield return Case(91, "NestedArrayLambdaBodyMissingSeparator", "{outer:{nested:{array:[{lambda:(x)=>{node:{leaf:1 twig:2}}}]}}}");
            ...
            yield return Case(94, "NestedArrayLambdaReturningLambdaMissingSeparator", "{outer:{nested:{array:[{lambda:(x)=>{return (y)=>{leaf:1 twig:2};}}}]}}");
            yield return Case(95, "NestedObjectMissingSeparatorAfterLambda", "{outer:{pipe:{lambda:(x)=>{node:{}}} extra:1}}");
            yield return Case(96, "NestedObjectMissingSeparatorAfterLambdaWithLeaf", "{outer:{pipe:{lambda:(x)=>{node:{leaf:}}} extra:1}}");
            yield return Case(97, "NestedObjectMissingSeparatorAfterLambdaMissingSeparator", "{outer:{pipe:{lambda:(x)=>{node:{leaf:1 twig:2}}} extra:1}}");
            ...
            yield return Case(100, "NestedObjectMissingSeparatorAfterLambdaReturningLambdaMissingSeparator", "{outer:{pipe:{lambda:(x)=>{return (y)=>{leaf:1 twig:2};}} extra:1}}");
        }
